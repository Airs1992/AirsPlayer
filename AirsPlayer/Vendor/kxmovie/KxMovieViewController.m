...
- (void)loadView
{
    ...
    _bottomHUD.frame = CGRectMake(0,height-(75),width,75);
...
//    _topHUD.backgroundColor = [UIColor whiteColor];
//    _bottomHUD.backgroundColor = [UIColor whiteColor];
    ...
    _doneButton.frame = CGRectMake(0,2,50,24);
    ...
    [_infoButton setImage:[UIImage imageNamed:@"retweet.png"] forState:UIControlStateNormal];
    _infoButton.frame = CGRectMake(width-20,3,20,25);
    [_infoButton setImageEdgeInsets:UIEdgeInsetsMake(0, -5, 0, 0)];
...
- (void) forwardDidTouch: (id) sender
{
    ...
    [self setMoviePosition: _moviePosition + 15];
}
